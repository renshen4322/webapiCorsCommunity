...
namespace Community.Core.Data
{
    ...
    public partial class DataSettingsManager
    {
        ...
        public virtual DataSettings LoadSettings(string filePath = null)
        {
            ...
            //{
            //    DataProvider = GlobalAppSettings.DATA_PROVIDER,
            //    DataConnectionString = GlobalAppSettings.MYSQL_CONNECTION
            //};
      ...
      /// <returns></returns>
        public virtual DataSettings LoadSettings(string dataProvider,string dataConnectionString)
        {
            return new DataSettings()
            {
